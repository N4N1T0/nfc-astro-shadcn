...
export const ui = {
  es: {
    'hero-description': 'Experimenta la Excelencia en Boxeo y Kickboxing con Entrenamiento Personalizado a Domicilio en Marbella, Diseñado para Adaptarse a Tu Ritmo y Objetivos, Maximizando Tu Potencial en las Artes Marciales de Combate.',
